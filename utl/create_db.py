...
def create():
    ...
    create_table_board = "CREATE TABLE IF NOT EXISTS board(board_id INTEGER, user_id INTEGER, board_name TEXT, row INTEGER, category TEXT, q1 INTEGER, q2 INTEGER, q3 INTEGER, q4 INTEGER, q5 INTEGER);"
    insert_dummy = "INSERT OR IGNORE INTO board(board_id) VALUES(0)"
    create_table_teams = "CREATE TABLE IF NOT EXISTS teams(game_id INTEGER, team_name TEXT, turn INTEGER, score INTEGER);"
    create_table_board_status = "CREATE TABLE IF NOT EXISTS board_status(user_id INTEGER, board_id INTEGER, game_id INTEGER, row INTEGER, category TEXT, q1 INTEGER, q2 INTEGER, q3 INTEGER, q4 INTEGER, q5 INTEGER);"
